...
router.put('/change', verifyToken, usercontroller.changePassword)
...
router.get('/admin', adminVerify, admin.getAllAdmin)
router.get('/adminusername', adminVerify, admin.getAdminUsername)
router.get('/ctrlrecipe', adminVerify, admin.ctrlRecipe)
